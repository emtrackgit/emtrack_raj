  ...
  Future<void> updateTyre() async {
    ...
    try {
      ...
      try {
        ...
        await SecureStorage.enqueuePendingEditTyre(jsonEncode(model.toJson()));
        AppLoader.hide();
        Get.snackbar(
          "Offline",
        ...
        if (e.toString().contains('Failed host lookup') ||
          ...
          await SecureStorage.enqueuePendingEditTyre(
      ...
      await PendingTyreSyncService.syncPendingEdits();
