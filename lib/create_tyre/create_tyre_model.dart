...
class CreateTyreModel {
  ...
  Map<String, dynamic> toJson() {
    ...
    double? _nullIfNonPositive(double? v) => (v == null || v <= 0) ? null : v;
    ...
    final data = <String, dynamic>{
      ...
      'brandNo': _nullIfEmpty(brandNo),
      'currentMiles': currentMiles,
      'currentHours': currentHours,
      'tireStatusId': tireStatusId,
      'wheelPosition': _nullIfEmpty(wheelPosition),
      'isMountToRim': isMountToRim,
      'mountedRimSerialNo': _nullIfEmpty(mountedRimSerialNo),
      'originalTread': originalTread,
      'purchasedTread': purchasedTread,
      'removeAt': _nullIfNonPositive(removeAt),
      ...
      'starRatingId': _nullIfZero(starRatingId),
      'plyId': _nullIfZero(plyId),
      'indCodeId': _nullIfZero(indCodeId),
      'compoundId': _nullIfZero(compoundId),
      'loadRatingId': _nullIfZero(loadRatingId),
      'speedRatingId': _nullIfZero(speedRatingId),
      'purchaseCost': purchaseCost,
      'casingValue': casingValue,
      'fillTypeId': _nullIfZero(fillTypeId),
      'fillCost': fillCost,
      ...
      'netCost': netCost,
      'vehicleNumber': _nullIfEmpty(vehicleNumber),
      'createdBy': _nullIfEmpty(createdBy),
      'isEditable': isEditable,
      'evaluationNo': _nullIfEmpty(evaluationNo),
      'lotNo': _nullIfEmpty(lotNo),
      'poNo': _nullIfEmpty(poNo),
      'imagesLocation': _nullIfEmpty(imagesLocation),
    };
