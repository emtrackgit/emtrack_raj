...
class VehicleController extends GetxController {
  ...
  Future<void> loadMasterData() async {
    ...
    // Keep Tyre Size list always available (do not clear on manufacturer/type changes)
  ...
  void selectType(String value) {
    ...
    final filteredTypes =
        types.where((e) => e.manufacturerId == manufacturerId.value).toList();
    final t = filteredTypes.firstWhere(
      (e) => e.typeName == value,
      orElse: () => filteredTypes.isNotEmpty ? filteredTypes.first : types.first,
    );
  ...
  void selectModel(String value) {
    ...
    final matched = models
        .where(
          (e) =>
              e.modelName == value &&
              e.vehicleManufacturerId == manufacturerId.value &&
              e.vehicleTypeId == typeId.value,
        )
        .toList();
