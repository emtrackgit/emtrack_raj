...
import '../widgets/vehicle_daigram.dart';
...
class UpdateVehicleView extends StatelessWidget {
  ...
  final VehicleInspeController inspCtrl =
      Get.put(VehicleInspeController(), tag: 'edit_vehicle_controller');
              ...
              return Column(
                ...
                children: [
                  ...
                  Builder(builder: (context) {
                    // Ensure we fetch tires once we know vehicle id
                    if (vc.vehicleId.value > 0 &&
                        inspCtrl.vehicleId.value != vc.vehicleId.value.toString()) {
                      inspCtrl.vehicleId.value = vc.vehicleId.value.toString();
                      inspCtrl.fetchInspectionData();
                    }
                    return Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        Obx(() {
                          return VehicleDiagram(
                            tires: inspCtrl.tires,
                            vehicleId: vc.vehicleId.value,
                            vehicleNumber: vc.vehicleNumberCtrl.text,
                          );
                        }),
                      ],
                    );
