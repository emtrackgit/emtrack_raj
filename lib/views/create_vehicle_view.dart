              ...
              () => Column(
                ...
                children: [
                  searchableDialogField(
                    ...
                    enabled: vc.manufacturerList.isNotEmpty,
                    onTap: vc.manufacturerList.isNotEmpty
                        ? () {
              ...
              () => Column(
                ...
                children: [
                  searchableDialogField(
                    ...
                    items: vc.typeList,
                    enabled:
                        vc.manufacturerId.value != 0 && vc.typeList.isNotEmpty,
              ...
              () => Column(
                ...
                children: [
                  searchableDialogField(
                    ...
                    items: vc.modelList,
                    enabled: vc.modelList.isNotEmpty,
                    onTap: vc.modelList.isNotEmpty
                        ? () {
                            _openFullScreenDialog(
              ...
              () => Column(
                ...
                children: [
                  searchableDialogField(
                    ...
                    enabled: vc.tyreSizeList.isNotEmpty,
                    onTap: vc.tyreSizeList.isNotEmpty
                        ? () {
                            _openFullScreenDialog(
